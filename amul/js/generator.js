...
if (siteProduct) {
    ...
    if (siteProduct.demonPopup) {
        ...
        $('body').append('<div class="demon_popup">\n' +
            ...
            '            <img src="img/product.png" alt="" style="width:200px">\n' +
            '            <p>Для Вас ещё действует специальное ограниченное предложение</p>\n' +
            '            <p>Успейте принять участие в программе и получите "' + siteProduct.name + '" по акции за    <span class="lt-product-price"></span><span style="font-size: 32px;color:#fff;">!</span></p>\n' +
